...
final $typed_data.Uint8List authenticationDescriptor = $convert.base64Decode('Cg5BdXRoZW50aWNhdGlvbhI0CgVydWxlcxgDIAMoCzIeLmdvb2dsZS5hcGkuQXV0aGVudGljYXRpb25SdWxlUgVydWxlcxI2Cglwcm92aWRlcnMYBCADKAsyGC5nb29nbGUuYXBpLkF1dGhQcm92aWRlclIJcHJvdmlkZXJz');
...
final $typed_data.Uint8List authenticationRuleDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List jwtLocationDescriptor = $convert.base64Decode('CgtKd3RMb2NhdGlvbhIYCgZoZWFkZXIYASABKAlIAFIGaGVhZGVyEhYKBXF1ZXJ5GAIgASgJSABSBXF1ZXJ5EiEKDHZhbHVlX3ByZWZpeBgDIAEoCVILdmFsdWVQcmVmaXhCBAoCaW4=');
...
const AuthProvider$json = const {
  ...
  '2': const [
    ...
    const {'1': 'jwt_locations', '3': 6, '4': 3, '5': 11, '6': '.google.api.JwtLocation', '10': 'jwtLocations'},
  ],
};

/// Descriptor for `AuthProvider`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List authProviderDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List oAuthRequirementsDescriptor = $convert.base64Decode('ChFPQXV0aFJlcXVpcmVtZW50cxIpChBjYW5vbmljYWxfc2NvcGVzGAEgASgJUg9jYW5vbmljYWxTY29wZXM=');
...
final $typed_data.Uint8List authRequirementDescriptor = $convert.base64Decode('Cg9BdXRoUmVxdWlyZW1lbnQSHwoLcHJvdmlkZXJfaWQYASABKAlSCnByb3ZpZGVySWQSHAoJYXVkaWVuY2VzGAIgASgJUglhdWRpZW5jZXM=');
