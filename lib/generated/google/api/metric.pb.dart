...
class MetricDescriptor_MetricDescriptorMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MetricDescriptor.MetricDescriptorMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api'), createEmptyInstance: create)
    ..e<$4.LaunchStage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $4.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $4.LaunchStage.valueOf, enumValues: $4.LaunchStage.values)
    ..aOM<$6.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'samplePeriod', subBuilder: $6.Duration.create)
    ..aOM<$6.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ingestDelay', subBuilder: $6.Duration.create)
  ...
  'Will be removed in next major version')
  MetricDescriptor_MetricDescriptorMetadata copyWith(void Function(MetricDescriptor_MetricDescriptorMetadata) updates) => super.copyWith((message) => updates(message as MetricDescriptor_MetricDescriptorMetadata)) as MetricDescriptor_MetricDescriptorMetadata; // ignore: deprecated_member_use
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set launchStage($4.LaunchStage v) { setField(1, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set samplePeriod($6.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set ingestDelay($6.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class MetricDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MetricDescriptor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..pc<$2.LabelDescriptor>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', $pb.PbFieldType.PM, subBuilder: $2.LabelDescriptor.create)
    ..e<MetricDescriptor_MetricKind>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metricKind', $pb.PbFieldType.OE, defaultOrMaker: MetricDescriptor_MetricKind.METRIC_KIND_UNSPECIFIED, valueOf: MetricDescriptor_MetricKind.valueOf, enumValues: MetricDescriptor_MetricKind.values)
    ..e<MetricDescriptor_ValueType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'valueType', $pb.PbFieldType.OE, defaultOrMaker: MetricDescriptor_ValueType.VALUE_TYPE_UNSPECIFIED, valueOf: MetricDescriptor_ValueType.valueOf, enumValues: MetricDescriptor_ValueType.values)
    ...
    ..aOM<MetricDescriptor_MetricDescriptorMetadata>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: MetricDescriptor_MetricDescriptorMetadata.create)
    ..e<$4.LaunchStage>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $4.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $4.LaunchStage.valueOf, enumValues: $4.LaunchStage.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MetricDescriptor copyWith(void Function(MetricDescriptor) updates) => super.copyWith((message) => updates(message as MetricDescriptor)) as MetricDescriptor; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(12)
  set launchStage($4.LaunchStage v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class Metric extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Metric', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Metric.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.api'))
