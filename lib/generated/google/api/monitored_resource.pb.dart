...
class MonitoredResourceDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MonitoredResourceDescriptor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..pc<$2.LabelDescriptor>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', $pb.PbFieldType.PM, subBuilder: $2.LabelDescriptor.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<$4.LaunchStage>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $4.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $4.LaunchStage.valueOf, enumValues: $4.LaunchStage.values)
  ...
  'Will be removed in next major version')
  MonitoredResourceDescriptor copyWith(void Function(MonitoredResourceDescriptor) updates) => super.copyWith((message) => updates(message as MonitoredResourceDescriptor)) as MonitoredResourceDescriptor; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  $core.List<$2.LabelDescriptor> get labels => $_getList(3);
  ...
  @$pb.TagNumber(7)
  $4.LaunchStage get launchStage => $_getN(5);
  @$pb.TagNumber(7)
  set launchStage($4.LaunchStage v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class MonitoredResource extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MonitoredResource copyWith(void Function(MonitoredResource) updates) => super.copyWith((message) => updates(message as MonitoredResource)) as MonitoredResource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MonitoredResourceMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MonitoredResourceMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api'), createEmptyInstance: create)
    ..aOM<$3.Struct>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'systemLabels', subBuilder: $3.Struct.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MonitoredResourceMetadata copyWith(void Function(MonitoredResourceMetadata) updates) => super.copyWith((message) => updates(message as MonitoredResourceMetadata)) as MonitoredResourceMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $3.Struct get systemLabels => $_getN(0);
  @$pb.TagNumber(1)
  set systemLabels($3.Struct v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSystemLabels() => $_has(0);
  @$pb.TagNumber(1)
  void clearSystemLabels() => clearField(1);
  @$pb.TagNumber(1)
  $3.Struct ensureSystemLabels() => $_ensure(0);
