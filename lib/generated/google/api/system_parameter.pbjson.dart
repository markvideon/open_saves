...
final $typed_data.Uint8List systemParametersDescriptor = $convert.base64Decode('ChBTeXN0ZW1QYXJhbWV0ZXJzEjUKBXJ1bGVzGAEgAygLMh8uZ29vZ2xlLmFwaS5TeXN0ZW1QYXJhbWV0ZXJSdWxlUgVydWxlcw==');
...
final $typed_data.Uint8List systemParameterRuleDescriptor = $convert.base64Decode('ChNTeXN0ZW1QYXJhbWV0ZXJSdWxlEhoKCHNlbGVjdG9yGAEgASgJUghzZWxlY3RvchI7CgpwYXJhbWV0ZXJzGAIgAygLMhsuZ29vZ2xlLmFwaS5TeXN0ZW1QYXJhbWV0ZXJSCnBhcmFtZXRlcnM=');
...
final $typed_data.Uint8List systemParameterDescriptor = $convert.base64Decode('Cg9TeXN0ZW1QYXJhbWV0ZXISEgoEbmFtZRgBIAEoCVIEbmFtZRIfCgtodHRwX2hlYWRlchgCIAEoCVIKaHR0cEhlYWRlchIuChN1cmxfcXVlcnlfcGFyYW1ldGVyGAMgASgJUhF1cmxRdWVyeVBhcmFtZXRlcg==');
